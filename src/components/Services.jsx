    ...
    <Section id="how-to-use">
      <div className="container">
        ...
        <div className="relative">
          ...
          >
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:2-3/5 xl:w-auto">
              <img
            ...
            <Generating
              className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg-right-auto lg:bottom-8
            lg:-translate-x-1/2"
            />
          </div>
